...
<div id="leftBar" class="tab1  flex-column justify-content-center px-0 col-md-3 bg-primary text-center text-decoration-none gap-3" style="height: 600px; display: flex">
    ...
    <c:if test="${role == 1}">
        ...
        <div class="but"> <a style="  color: white; text-decoration:none" href="http://localhost:8080/PRJProjectFinal/myCourseServlet" > <i class="fas fa-book"></i> Khóa học của tôi</a></div>
