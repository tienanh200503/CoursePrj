    ...
    <body>
        ...
        <div class="contain" style="margin-top: 100px">
            ...
            <h2 class="title-course">
                <i class="fas fa-book"></i> Kết Quả Tìm Kiếm <i class="fas fa-fire fa-xs" style="color: red;"></i>
            </h2>

            <div class="featuredCourse" style="margin-bottom: 3rem ">
                <c:choose>
                    <c:when test="${empty sessionScope.listCourse}">
                        <h5>Không có khóa học bạn cần tìm</h5>
                    </c:when>
                    <c:otherwise>
